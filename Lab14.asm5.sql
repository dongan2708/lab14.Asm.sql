...
ContactNumber int,
PersonID int,
CONSTRAINT fk_Person FOREIGN KEY (PersonID) REFERENCES Person(PeraonID)
)
GO

INSERT INTO Person values (11,N'Nguyễn Văn An',N'111 Nguyễn Trãi,THanh Xuân,Hà Nội','1987-8-11'),
                          (12,N'Nguyễn Đức Hiền',N'Long An,Tiền Giang','1991-07-22'),
                          (13,N'Hoàng Thị Kim Cúc',N'Hà Nam','1994-04-20'),
                          (14,N'Dương Thị Nhàn',N'Hải Dương','1992-12-25'),
                          (15,N'Trần Đức Tùng',N'Hà Nội','1995-12-15')
...
CREATE INDEX IX_SoDienThoa
iON Contact(ContactNumber)
--b) Viết các View sau:
...
INSERT INTO Person VALUES (16, N'Trần Xuân Cường', N'Bắc Ninh', '1996-12-18')
